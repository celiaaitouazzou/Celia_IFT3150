...
<li>On tente de récursivement passer à travers l'arbre XML et ceci m'aide avec la récursivité<<a href="https://stackoverflow.com/questions/5223/length-of-a-javascript-object">https://stackoverflow.com/questions/5223/length-of-a-javascript-object</a>.Puis itérerer à travers un objet et faire qu'on s'en souvienne lors du prochain appel récursif.On essaie également d'accumuler l'objet actuel dans une data structure tout en faisant la récursion mais souvent on a 'can't push on undefined' </li>
